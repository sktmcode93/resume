...
const Portfolio = () => {
    ...
    return <HomeLayout cn="portfolio h-main">
        <ul className="pf-list">
            <PortList image={thumb_dday} title="D-Day Counter" targetPage="/resume/d-day-counter">
            ...
            <PortList image={thumb_todolist} title="Todo List" targetPage="/resume/todo-list">
                <p>- localStorage를 통해 데이터를 보존</p>
                <p>- 카테고리 및 Todo 입력 및 완료사항 체크</p>
                <p>- 각 카테고리 색깔 변경</p>
                <p>- 데이터 초기화 및 예시값 적용 기능</p>
            </PortList>
            <PortList image={thumb_moviebank} title="Movie Bank" targetPage="/resume/movie-bank">
